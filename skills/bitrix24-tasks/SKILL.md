---
name: bitrix24-tasks
description: "Bitrix24 Tasks tasks: Bitrix24 tasks, checklists, comments, projects/groups."
metadata: {"openclaw":{},"nango":{"family":"bitrix24","provider_config_key":"bitrix24-tasks"}}
---

# Bitrix24 Tasks

Use this skill when the user requests Bitrix24 tasks, checklists, comments, projects/groups through the configured Nango connection.

- Route only to `providerConfigKey`: **`bitrix24-tasks`**.

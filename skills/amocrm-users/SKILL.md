---
name: amocrm-users
description: "amoCRM Users & Structure tasks: amoCRM managers, groups, account users."
metadata: {"openclaw":{},"nango":{"family":"amocrm","provider_config_key":"amocrm-users"}}
---

# amoCRM Users & Structure

Use this skill when the user requests amoCRM managers, groups, account users through the configured Nango connection.

- Route only to `providerConfigKey`: **`amocrm-users`**.

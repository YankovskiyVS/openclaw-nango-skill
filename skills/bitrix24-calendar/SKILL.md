...
description: "Bitrix24 Calendar tasks: Bitrix24 calendar, meetings, room booking."
metadata: {"openclaw":{},"nango":{"family":"bitrix24","provider_config_key":"bitrix24-calendar"}}
---

# Bitrix24 Calendar

Use this skill when the user requests Bitrix24 calendar, meetings, room booking through the configured Nango connection.

- Route only to `providerConfigKey`: **`bitrix24-calendar`**.

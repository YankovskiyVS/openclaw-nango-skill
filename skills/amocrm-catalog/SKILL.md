---
name: amocrm-catalog
description: "amoCRM Catalog & Purchases tasks: amoCRM products, catalogs, purchases."
metadata: {"openclaw":{},"nango":{"family":"amocrm","provider_config_key":"amocrm-catalog"}}
---

# amoCRM Catalog & Purchases

Use this skill when the user requests amoCRM products, catalogs, purchases through the configured Nango connection.

- Route only to `providerConfigKey`: **`amocrm-catalog`**.

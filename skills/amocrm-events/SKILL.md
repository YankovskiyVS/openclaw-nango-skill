---
name: amocrm-events
description: "amoCRM Events & Feed tasks: amoCRM activity history, notes, change feed."
metadata: {"openclaw":{},"nango":{"family":"amocrm","provider_config_key":"amocrm-events"}}
---

# amoCRM Events & Feed

Use this skill when the user requests amoCRM activity history, notes, change feed through the configured Nango connection.

- Route only to `providerConfigKey`: **`amocrm-events`**.
...
```json
{
  "providerConfigKey": "amocrm-events",
  "method": "GET",
  "path": "api/v4/events",
  "mode": "link",
  "maxPages": 10,

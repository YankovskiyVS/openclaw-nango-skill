---
name: bitrix24
description: "Bitrix24 tasks: generic Bitrix24 requests; prefer module skills (crm/tasks/…) when available."
metadata: {"openclaw":{},"nango":{"family":"bitrix24","provider_config_key":"bitrix24"}}
---

# Bitrix24

Use this skill when the user requests generic Bitrix24 requests; prefer module skills (crm/tasks/…) when available through the configured Nango connection.

- Route only to `providerConfigKey`: **`bitrix24`**.
- Scopes / access: `user`

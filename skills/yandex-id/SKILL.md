---
name: yandex-id
description: "Yandex ID tasks: Yandex profile, login, email, avatar, or account identity."
metadata: {"openclaw":{},"nango":{"family":"yandex","provider_config_key":"yandex-id"}}
---

# Yandex ID

Use this skill when the user requests Yandex profile, login, email, avatar, or account identity through the configured Nango connection.

- Route only to `providerConfigKey`: **`yandex-id`**.

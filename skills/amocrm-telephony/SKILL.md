...
description: "amoCRM Telephony tasks: amoCRM calls, telephony, call records."
metadata: {"openclaw":{},"nango":{"family":"amocrm","provider_config_key":"amocrm-telephony"}}
---

# amoCRM Telephony

Use this skill when the user requests amoCRM calls, telephony, call records through the configured Nango connection.

- Route only to `providerConfigKey`: **`amocrm-telephony`**.

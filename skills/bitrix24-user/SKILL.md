---
name: bitrix24-user
description: "Bitrix24 Users & Structure tasks: Bitrix24 employees, departments, org chart."
metadata: {"openclaw":{},"nango":{"family":"bitrix24","provider_config_key":"bitrix24-user"}}
---

# Bitrix24 Users & Structure

Use this skill when the user requests Bitrix24 employees, departments, org chart through the configured Nango connection.

- Route only to `providerConfigKey`: **`bitrix24-user`**.

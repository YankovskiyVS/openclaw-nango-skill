...
description: "Bitrix24 Business Processes tasks: start or inspect Bitrix24 workflows, robots, or bizproc."
metadata: {"openclaw":{},"nango":{"family":"bitrix24","provider_config_key":"bitrix24-bizproc"}}
---

# Bitrix24 Business Processes

Use this skill when the user requests start or inspect Bitrix24 workflows, robots, or bizproc through the configured Nango connection.

- Route only to `providerConfigKey`: **`bitrix24-bizproc`**.

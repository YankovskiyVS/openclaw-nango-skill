---
name: amocrm
description: "amoCRM tasks: generic amoCRM questions; prefer module skills when installed."
metadata: {"openclaw":{},"nango":{"family":"amocrm","provider_config_key":"amocrm"}}
---

# amoCRM

Use this skill when the user requests generic amoCRM questions; prefer module skills when installed through the configured Nango connection.

- Route only to `providerConfigKey`: **`amocrm`**.

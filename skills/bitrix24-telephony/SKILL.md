...
description: "Bitrix24 Telephony tasks: Bitrix24 calls, call records, or telephony."
metadata: {"openclaw":{},"nango":{"family":"bitrix24","provider_config_key":"bitrix24-telephony"}}
---

# Bitrix24 Telephony

Use this skill when the user requests Bitrix24 calls, call records, or telephony through the configured Nango connection.

- Route only to `providerConfigKey`: **`bitrix24-telephony`**.
